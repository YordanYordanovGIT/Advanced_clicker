...
namespace Advanced_clicker
{
	public partial class Form1 : Form
	{
		...
		public Form1()
		{
			...
			RegisterHotKey(this.Handle, id, (int)KeyModifier.Shift, Keys.E.GetHashCode());       // Register Shift + E as global hotkey. 
		...
		{
			MessageBox.Show("To get mouse position click on the text box, place your mouse on the desired position, then press 'Enter'.", "Tip", MessageBoxButtons.OK, MessageBoxIcon.Information);
		}
		...
		{
			DialogResult result = MessageBox.Show("To exit press 'Shift + E'!", "Important", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
